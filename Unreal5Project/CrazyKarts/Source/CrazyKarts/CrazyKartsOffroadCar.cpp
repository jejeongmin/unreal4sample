...
#include "CrazyKartsOffroadCar.h"
#include "CrazyKartsOffroadWheelFront.h"
#include "CrazyKartsOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ACrazyKartsOffroadCar::ACrazyKartsOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCrazyKartsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCrazyKartsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCrazyKartsOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCrazyKartsOffroadWheelRear::StaticClass();
