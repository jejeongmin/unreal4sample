...
#include "CrazyKartsPlayerController.generated.h"

class UInputMappingContext;
class ACrazyKartsPawn;
class UCrazyKartsUI;
 ...
 */
UCLASS(abstract)
class CRAZYKARTS_API ACrazyKartsPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ACrazyKartsPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UCrazyKartsUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UCrazyKartsUI> VehicleUI;
