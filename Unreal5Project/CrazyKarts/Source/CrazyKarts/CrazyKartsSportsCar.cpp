...
#include "CrazyKartsSportsCar.h"
#include "CrazyKartsSportsWheelFront.h"
#include "CrazyKartsSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACrazyKartsSportsCar::ACrazyKartsSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCrazyKartsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCrazyKartsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCrazyKartsSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCrazyKartsSportsWheelRear::StaticClass();
