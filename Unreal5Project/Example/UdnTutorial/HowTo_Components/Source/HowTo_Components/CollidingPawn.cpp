...
void ACollidingPawn::NotifyControllerChanged()
{
...
void ACollidingPawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		// Jumping
		EnhancedInputComponent->BindAction(ParticleToggleAction, ETriggerEvent::Started, this, &ACollidingPawn::ParticleToggle);

		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACollidingPawn::Move);

		// Looking
		EnhancedInputComponent->BindAction(TurnAction, ETriggerEvent::Triggered, this, &ACollidingPawn::Look);
	}
}
...
void ACollidingPawn::Move(const FInputActionValue& Value)
{
	...
	if (Controller != nullptr)
	{
		...
		{
			OurMovementComponent->AddInputVector(GetActorForwardVector() * MovementVector.Y);
			OurMovementComponent->AddInputVector(GetActorRightVector() * MovementVector.X);
		}
	}
}

void ACollidingPawn::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
