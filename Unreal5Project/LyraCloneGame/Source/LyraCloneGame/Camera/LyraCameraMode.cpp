...
{
	// 우리가 앞서 ULyraCameraMode를 생성하는 곳은 ULyraCameraModeStack이었다:
	// - 해당 코드를 보면, GetOuter()를 LyraCameraMode로 LyraCameraComponent로 설정하였다
	// - ULyraCameraModeStack::GetCameraModeInstance() 확인
